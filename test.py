...
name = 'SP3_driven_Ax_w_dA_dC_1_10_5_-5'
file = 'figures/square/SP3/driven/bandstructures/scan2/' + name + '/' + name + '_grids/' + name + '_grid.npy'
energies = np.load(file)

a_1 = np.array([1,0])
a_2 = np.array([0,1])

locate_nodes(energies, a_1, a_2, 'test.png', node_threshold=0.04)
