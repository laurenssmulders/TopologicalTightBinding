...
for i in range(num_points):
    for j in range(num_points):
        S[i,j] = np.diag([np.exp(-1j*np.pi*(j-i)/num_points),
                          np.exp(-1j*np.pi*j/num_points),
                          np.exp(-1j*np.pi*i/num_points)])
...
for i in range(2*N+1):
    for j in range(2*N+1):
        ...
        integrand1A = np.matmul(np.matmul(np.conjugate(np.transpose(S,(0,1,3,2))),H1A),S) * exponent
        integrand1B = np.matmul(np.matmul(np.conjugate(np.transpose(S,(0,1,3,2))),H1B),S) * exponent
        integrand2A = np.matmul(np.matmul(np.conjugate(np.transpose(S,(0,1,3,2))),H2A),S) * exponent
        integrand2B = np.matmul(np.matmul(np.conjugate(np.transpose(S,(0,1,3,2))),H2B),S) * exponent
        integrand3A = np.matmul(np.matmul(np.conjugate(np.transpose(S,(0,1,3,2))),H3A),S) * exponent
        integrand3B = np.matmul(np.matmul(np.conjugate(np.transpose(S,(0,1,3,2))),H3B),S) * exponent
        integrand4A = np.matmul(np.matmul(np.conjugate(np.transpose(S,(0,1,3,2))),H4A),S) * exponent
        integrand4B = np.matmul(np.matmul(np.conjugate(np.transpose(S,(0,1,3,2))),H4B),S) * exponent
...
np.save('hoppings_kagome/J1A.npy',J1A)
np.save('hoppings_kagome/J1B.npy',J1B)
np.save('hoppings_kagome/J2A.npy',J2A)
np.save('hoppings_kagome/J2B.npy',J2B)
np.save('hoppings_kagome/J3A.npy',J3A)
np.save('hoppings_kagome/J3B.npy',J3B)
np.save('hoppings_kagome/J4A.npy',J4A)
np.save('hoppings_kagome/J4B.npy',J4B)
